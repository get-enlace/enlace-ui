...
OperationNode {
  ...
  kind?: "operation"        // absent = "operation" (back-compat default)
...
PresetsNode {
  ...
  presets?: Preset[]        // ordered presets run as one unit
}
