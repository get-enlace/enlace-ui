...
export function ChromeSettingsMenu() {
  ...
  return (
    <div className="chrome-settings" ref={rootRef}>
      <button
        type="button"
        className="chrome-settings__trigger btn btn--icon btn--secondary"
        aria-label="Settings"
        aria-haspopup="menu"
      ...
      {menuOpen && (
        <div className="chrome-settings__menu" role="menu" aria-label="Settings">
          <button
            type="button"
            role="menuitem"
...
function SettingsGearIcon() {
  return (
    <svg className="chrome-settings__icon" viewBox="0 0 24 24" width="16" height="16" aria-hidden="true">
      <path
        fill="currentColor"
